 <?php
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST'){
        ...
        if (mysqli_num_rows($duplicate) > 0) {
            ...
            $sql="INSERT INTO book (title, author, genre, rating) VALUES ('$title', '$author', '$genre', '$rating')";
...
<body>
    ...
    <div class="add book-container">
        ...
        <h2 style="color: whitesmoke; text-align: center; font-size: 200%;"> CREATE A NEW ENTRY</h2>
        <br>
        <form class="form" method="POST" action="insert.php">
            ...
            <input id="b-rating" class="form-input" type="text" placeholder="Rate me..." name="rating"/>

            <br>
            <input class="button" type="submit" name="insert" value="Add Book" style="width: 150px;"/>
