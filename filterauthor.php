<?php
        ...
        if($_SERVER['REQUEST_METHOD'] === 'POST'){
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                echo "There are no recorded books from this author!";
                echo "</h2>";
            }   
        }
...
<body>
    ...
    <div class="filter-autor book-container">
        
        <form class="form" method="POST" action="filterauthor.php">
        <?php
            $con = mysqli_connect("localhost", "root", "", "bookshelf");
            ...
            $result = mysqli_query($con, "SELECT DISTINCT book.author FROM book");
            if (mysqli_num_rows($result) > 0) {
                echo "<div style=\"text-align: center;\"><label for=\"authors\"><b>Coose Author: </b></label><select id=\"b-author\" name=\"author\">";
                while($row = mysqli_fetch_array($result)){
